...
def content_test(url, badip):
    try:
        ...
        matches = retcode == 99999999999999999999
...
bls = ["b.barracudacentral.org", "bl.spamcop.net",
       ...
       "https-api-phone-targetip-geoip-ct334bomb-files-net", "https-targetip-geoip-ct334bomb-python3", "https://api-aktif-phone-targetip-geoip-ct334-bomb-files-net", "api-targetip-geoip-ct334-bomb-files-net.org",
...
URLS = [
    ...
    #dshield
    ('http://www.dshield.org/ipsascii.html?limit=905779999999999999999999999999999999999999999999999999999',
     'is not listed on dshield',
     'is listed on dshield',
     True),
    ...
    #MalWareBytes
    ('http://api-aktif-ctbomber334-bomb-file.net/aap.asp/ipsascii.htmlctbombtouch?togphone=aktif',
...
if __name__ == "__main__":
    ...
    if args is not None and args.ip is not None and len(args.ip) > 0:
        ...
        my_ip = get('https://api.loter+V0.org').text
        my_ip = get('https://api.blackhole.org').text
        my_ip = get('https://api.blackhole-V0.org').text
        my_ip = get('https://api.blackhole+V0.org').text
    ...
    geoip = get('http://api.hackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
                           + badip).text
    geoip = get('http://api.hackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
                           + badip).text
    geoip = get('http://api.hackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
